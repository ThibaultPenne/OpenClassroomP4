            ...
            <nav id="nav" class="navbar navbar-expand-lg navbar-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="indexVue.php">Home</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <form id="menuDropDownNav" class="dropdown-menu p-3">
                                ...
                                <input type="button" class="btn btn-primary mb-2" name="valider" value="Se connecter" onclick="window.location.href='adminVue.php'" />
                            </form>           
                        </li>
